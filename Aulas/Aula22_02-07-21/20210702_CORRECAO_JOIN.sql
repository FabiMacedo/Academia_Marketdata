...
--4. Exiba os produtos que foram vendidos, mas a data da venda está fora do período inicial 
--e final cadastrado na tabela de produtos. Considere que produtos sem data final de venda ainda 
--estão sendo comercializados. Exiba somente o nome do produto, data de inicio de venda e data final de venda.
